...
public class DevicePicker {
    ...
    public AlertDialog getPickerDialog(String message, final OnItemClickListener listener) {
        ...
        TextView title = (TextView) activity.getLayoutInflater().inflate(R.layout.header_dialog, null);
        title.setText(message);

        final AlertDialog pickerDialog = new AlertDialog.Builder(activity,R.style.MyDialogTheme)
